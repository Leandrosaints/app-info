...
links = [
    ...
    {"text": "form Salas", "url": "#","icon": "fa-solid fa-list-check"},#https://forms.gle/6eUoZDu63GjgML169
    {"text": "form Labs", "url": "#","icon": "fa-solid fa-desktop"}#https://forms.gle/JHXVPmYh3TWfbcs96
]
links_forms = [
    {"text": "LAB MECANICA AUTOMOTIVA", "url": "https://forms.gle/auZYVEfa1nU9WCCv6", "icon": "fa-regular fa-play"},
    {"text": "LAB DE ALIMENTOS", "url": "https://forms.gle/vSrfrLJyT3pLiNjF8", "icon": "fa-regular fa-play"},
    {"text": "LAB DE ELÉTRICA IND", "url": "https://forms.gle/P4XgwPKA2LvMbBvS8", "icon": "fa-regular fa-play"},
